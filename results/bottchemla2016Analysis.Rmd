---
title: Scripts to analyse a replication of Bott and Chemla 2016.Scripts to analyse
  a replication of Bott and Chemla 2016
author: "bsparkes"
date: "24th May 2018"
output:
...
library(stargazer) # for latex export
# library(quantmod)
library(dplyr)
```
...
Of course, our interest is in a restriction of the main dataset so that 

```{r}
wrp.modelWithin = glmer(responseChoice ~ primeStrength * WithCat +  (1 + primeStrength * WithCat | workerid), data=wrp, family = binomial(link = "logit"))
...
```{r}
brp.modelBetween = glmer(responseChoice ~ primeStrength * BetCat  +  (1 + primeStrength * BetCat | workerid), data=brp, family = binomial(link = "logit"))
...
strongNUM4NUM4MeanPlusSE <- (strongNUM4NUM4Mean + strongNUM4NUM4SE)
weakNUM4NUM4MeanPlusSE <- (weakNUM4NUM4Mean + weakNUM4NUM4SE)
strongNUM4SOMEMeanPlusSE <- (strongNUM4SOMEMean + strongNUM4SOMESE)
weakNUM4SOMEMeanPlusSE <- (weakNUM4SOMEMean + weakNUM4SOMESE)
strongSOMENUM4MeanPlusSE <- (strongSOMENUM4Mean + strongSOMENUM4SE)
weakSOMENUM4MeanPlusSE <- (weakSOMENUM4Mean + weakSOMENUM4SE)
strongSOMESOMEMeanPlusSE <- (strongSOMESOMEMean + strongSOMESOMESE)
weakSOMESOMEMeanPlusSE <- (weakSOMESOMEMean + weakSOMESOMESE)
...
strongNUM4NUM4MeanMinusSE <- (strongNUM4NUM4Mean - strongNUM4NUM4SE)
weakNUM4NUM4MeanMinusSE <- (weakNUM4NUM4Mean - weakNUM4NUM4SE)
strongNUM4SOMEMeanMinusSE <- (strongNUM4SOMEMean - strongNUM4SOMESE)
weakNUM4SOMEMeanMinusSE <- (weakNUM4SOMEMean - weakNUM4SOMESE)
strongSOMENUM4MeanMinusSE <- (strongSOMENUM4Mean - strongSOMENUM4SE)
weakSOMENUM4MeanMinusSE <- (weakSOMENUM4Mean - weakSOMENUM4SE)
strongSOMESOMEMeanMinusSE <- (strongSOMESOMEMean - strongSOMESOMESE)
weakSOMESOMEMeanMinusSE <- (weakSOMESOMEMean - weakSOMESOMESE)
...
meanPlusSEPercent <- c(strongNUM4NUM4MeanPlusSEPercentage, weakNUM4NUM4MeanPlusSEPercentage, strongNUM4SOMEMeanPlusSEPercentage, weakNUM4SOMEMeanPlusSEPercentage, strongSOMENUM4MeanPlusSEPercentage, weakSOMENUM4MeanPlusSEPercentage, strongSOMESOMEMeanPlusSEPercentage, weakSOMESOMEMeanPlusSEPercentage)

meanMinusSEPercent <- c(strongNUM4NUM4MeanMinusSEPercentage, weakNUM4NUM4MeanMinusSEPercentage, strongNUM4SOMEMeanMinusSEPercentage, weakNUM4SOMEMeanMinusSEPercentage, strongSOMENUM4MeanMinusSEPercentage, weakSOMENUM4MeanMinusSEPercentage, strongSOMESOMEMeanMinusSEPercentage, weakSOMESOMEMeanMinusSEPercentage)
...
rawMeanPlusSE <- c(strongNUM4NUM4MeanPlusSE, weakNUM4NUM4MeanPlusSE, strongNUM4SOMEMeanPlusSE, weakNUM4SOMEMeanPlusSE, strongSOMENUM4MeanPlusSE, weakSOMENUM4MeanPlusSE, strongSOMESOMEMeanPlusSE, weakSOMESOMEMeanPlusSE)

rawMeanMinusSE <- c(strongNUM4NUM4MeanMinusSE, weakNUM4NUM4MeanMinusSE, strongNUM4SOMEMeanMinusSE, weakNUM4SOMEMeanMinusSE, strongSOMENUM4MeanMinusSE, weakSOMENUM4MeanMinusSE, strongSOMESOMEMeanMinusSE, weakSOMESOMEMeanMinusSE)



bars.data <- data.frame(primeCategory, meanPercent, meanPlusSEPercent, meanMinusSEPercent, rawMean, rawSD,  rawSE, rawMeanPlusSE, rawMeanMinusSE)
bars.data
